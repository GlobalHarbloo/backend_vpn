...
mixin _$User {
  ...
  int? get traffic => throw _privateConstructorUsedError;
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, uuid: $uuid, tariffId: $tariffId, traffic: $traffic, expiresAt: $expiresAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, uuid, tariffId, traffic, expiresAt);
...
abstract class _User implements User {
  const factory _User(
      ...
      final String? uuid,
      @JsonKey(name: 'tariff_id') final int? tariffId,
      final int? traffic,
      @JsonKey(name: 'expires_at', fromJson: _dateTimeFromJson)
      final DateTime? expiresAt}) = _$UserImpl;
